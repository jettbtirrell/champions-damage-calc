export const ITEMS = {
  ...
  // ── Mega Stones ────────────────────────────────────────────────────────────
  'abomasite':      { label: 'Abomasite',      effect: 'none' },
  'absolite':       { label: 'Absolite',       effect: 'none' },
  'aerodactylite':  { label: 'Aerodactylite',  effect: 'none' },
  'aggronite':      { label: 'Aggronite',      effect: 'none' },
  'alakazite':      { label: 'Alakazite',      effect: 'none' },
  'altarianite':    { label: 'Altarianite',    effect: 'none' },
  'ampharosite':    { label: 'Ampharosite',    effect: 'none' },
  'audinite':       { label: 'Audinite',       effect: 'none' },
  'banettite':      { label: 'Banettite',      effect: 'none' },
  'beedrillite':    { label: 'Beedrillite',    effect: 'none' },
  'blastoisinite':  { label: 'Blastoisinite',  effect: 'none' },
  'cameruptite':    { label: 'Cameruptite',    effect: 'none' },
  'charizardite-x': { label: 'Charizardite X', effect: 'none' },
  'charizardite-y': { label: 'Charizardite Y', effect: 'none' },
  'chandelurite':   { label: 'Chandelurite',   effect: 'none' },
  'chesnaughtite':  { label: 'Chesnaughtite',  effect: 'none' },
  'chimechite':     { label: 'Chimechite',     effect: 'none' },
  'clefablite':     { label: 'Clefablite',     effect: 'none' },
  'crabominite':    { label: 'Crabominite',    effect: 'none' },
  'delphoxite':     { label: 'Delphoxite',     effect: 'none' },
  'dragoninite':    { label: 'Dragoninite',    effect: 'none' },
  'drampanite':     { label: 'Drampanite',     effect: 'none' },
  'emboarite':      { label: 'Emboarite',      effect: 'none' },
  'excadrite':      { label: 'Excadrite',      effect: 'none' },
  'feraligite':     { label: 'Feraligite',     effect: 'none' },
  'floettite':      { label: 'Floettite',      effect: 'none' },
  'froslassite':    { label: 'Froslassite',    effect: 'none' },
  'galladite':      { label: 'Galladite',      effect: 'none' },
  'garchompite':    { label: 'Garchompite',    effect: 'none' },
  'gardevoirite':   { label: 'Gardevoirite',   effect: 'none' },
  'gengarite':      { label: 'Gengarite',      effect: 'none' },
  'glalitite':      { label: 'Glalitite',      effect: 'none' },
  'glimmoranite':   { label: 'Glimmoranite',   effect: 'none' },
  'golurkite':      { label: 'Golurkite',      effect: 'none' },
  'greninjite':     { label: 'Greninjite',     effect: 'none' },
  'gyaradosite':    { label: 'Gyaradosite',    effect: 'none' },
  'hawluchanite':   { label: 'Hawluchanite',   effect: 'none' },
  'heracronite':    { label: 'Heracronite',    effect: 'none' },
  'houndoominite':  { label: 'Houndoominite',  effect: 'none' },
  'kangaskhanite':  { label: 'Kangaskhanite',  effect: 'none' },
  'lopunnite':      { label: 'Lopunnite',      effect: 'none' },
  'lucarionite':    { label: 'Lucarionite',    effect: 'none' },
  'manectite':      { label: 'Manectite',      effect: 'none' },
  'medichamite':    { label: 'Medichamite',    effect: 'none' },
  'meganiumite':    { label: 'Meganiumite',    effect: 'none' },
  'meowsticite':    { label: 'Meowsticite',    effect: 'none' },
  'pidgeotite':     { label: 'Pidgeotite',     effect: 'none' },
  'pinsirite':      { label: 'Pinsirite',      effect: 'none' },
  'sablenite':      { label: 'Sablenite',      effect: 'none' },
  'scizorite':      { label: 'Scizorite',      effect: 'none' },
  'scovillainite':  { label: 'Scovillainite',  effect: 'none' },
  'sharpedonite':   { label: 'Sharpedonite',   effect: 'none' },
  'skarmorite':     { label: 'Skarmorite',     effect: 'none' },
  'slowbronite':    { label: 'Slowbronite',    effect: 'none' },
  'starminite':     { label: 'Starminite',     effect: 'none' },
  'steelixite':     { label: 'Steelixite',     effect: 'none' },
  'tyranitarite':   { label: 'Tyranitarite',   effect: 'none' },
  'venusaurite':    { label: 'Venusaurite',    effect: 'none' },
  'victreebelite':  { label: 'Victreebelite',  effect: 'none' },
};
...
export const ITEM_GROUPS = [
  ...
  { label: 'Mega Stones',             keys: ['abomasite', 'absolite', 'aerodactylite', 'aggronite', 'alakazite', 'altarianite', 'ampharosite', 'audinite', 'banettite', 'beedrillite', 'blastoisinite', 'cameruptite', 'charizardite-x', 'charizardite-y', 'chandelurite', 'chesnaughtite', 'chimechite', 'clefablite', 'crabominite', 'delphoxite', 'dragoninite', 'drampanite', 'emboarite', 'excadrite', 'feraligite', 'floettite', 'froslassite', 'galladite', 'garchompite', 'gardevoirite', 'gengarite', 'glalitite', 'glimmoranite', 'golurkite', 'greninjite', 'gyaradosite', 'hawluchanite', 'heracronite', 'houndoominite', 'kangaskhanite', 'lopunnite', 'lucarionite', 'manectite', 'medichamite', 'meganiumite', 'meowsticite', 'pidgeotite', 'pinsirite', 'sablenite', 'scizorite', 'scovillainite', 'sharpedonite', 'skarmorite', 'slowbronite', 'starminite', 'steelixite', 'tyranitarite', 'venusaurite', 'victreebelite'] },
];
